...
var App = function(targetElementId, viewWidth, viewHeight, squaresX, squaresY){
	...
	me.canvas.addEventListener('touchstart', handleClick);
	me.canvas.addEventListener('touchmove', handleClick);
	me.canvas.addEventListener('touchend', handleClick);
/*
...
var app = new App("game", window.innerWidth, window.innerHeight, Math.round(window.innerWidth/8), Math.round(window.innerHeight/8));
app.start();
